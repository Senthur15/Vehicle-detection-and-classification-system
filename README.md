...
* [SORT](https://arxiv.org/abs/1602.00763) to track those objects over different frames.
...
$ python main.py --input input/inputvideo.mp4 --output output/outputvideo.avi --yolo yolo-coco
